...
public class reports extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 150, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel3))
        );
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 150, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel4))
        );
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 144, Short.MAX_VALUE)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 930, 370));
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        ...
        ResultSet rs = s.executeQuery("SELECT * FROM finance_cheq");
        ...
        while (rs.next()) {
            ...
            cheqid = (rs.getString("cheq_id"));
            bank = (rs.getString("bank_info"));
            income = (rs.getString("income"));
            acctyp = (rs.getString("account_name"));
            accno = (rs.getString("account_no"));

            table.addCell(idno);
            table.addCell(cheqid);
            table.addCell(bank);
            table.addCell(income);
            table.addCell(acctyp);
            table.addCell(accno);
            //document.add(table);
    ...
    private void jPanel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel7MouseClicked
        ...
        Connection c = DB.mycon();
        Statement s = c.createStatement();
        ResultSet rs = s.executeQuery("SELECT * FROM costs");
        Document document = new Document();
    ...
    private void jPanel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel8MouseClicked
        ...
        document.open();          
        document.add(new Paragraph("HELLO love how are you ... This is your report"));
        document.add(new Paragraph(new Date().toString()));
        document.add(new Paragraph("____________________________________________________________________________"));
        document.add(new Paragraph("."));
        PdfPTable table = new PdfPTable(6);
