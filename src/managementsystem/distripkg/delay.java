...
public class delay extends javax.swing.JFrame {
    ...
    public delay() {
        ...
        try {
            String sql = "Select client_id from distribution_delivery_time";
    ...
    private void ConfirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmButtonActionPerformed
        ...
        String date = sdf.format(jSpinner1.getValue());

        try {
            String q = "Update distribution_delivery_time set arrival_time = '" + date + "', delay = 'yes' where client_id = '" + clientID + "'";
            st = c.prepareStatement(q);
            st.execute(q);
            JOptionPane.showConfirmDialog(null, "update delay successful ", "Distribution", JOptionPane.PLAIN_MESSAGE);
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
