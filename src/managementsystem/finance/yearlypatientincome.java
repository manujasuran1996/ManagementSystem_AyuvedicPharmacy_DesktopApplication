 ...
 * @author KALINDU
 */
public class yearlypatientincome extends javax.swing.JFrame {

    /** Creates new form yearlypatientincome */
    
    int xx,xy;
    
    public yearlypatientincome() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Verdana", 0, 60)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("yearly patients' income");
        ...
        jLabel4.setText("total doctor fee");
        ...
        jLabel9.setText("total channel fee");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 930, 410));
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT SUM(ChanelFee) FROM appointment WHERE date LIKE '"+jTextField1.getText()+"%' ");
            ResultSet rs1 = s1.executeQuery("SELECT SUM(DoctorFee) FROM appointment WHERE date LIKE '"+jTextField1.getText()+"%' ");
            if(rs.next()){
                if(rs.getString("SUM(ChanelFee)")!=null){
                sum = rs.getString("SUM(ChanelFee)");
                }else{
                    sum = "0";
                    JOptionPane.showMessageDialog(null, "No Data on channel fee that Year!");
                    jTextField1.setText(null);
                    jLabel15.setText(null);
                    jLabel14.setText(null);
                    jLabel16.setText(null);
                ...
                jLabel15.setText(df.format(Double.parseDouble(sum)));
            }
            if(rs1.next()){
                if(rs1.getString("SUM(DoctorFee)")!= null){
                docsum = rs1.getString("SUM(DoctorFee)");
            }else{
                    docsum = "0";
                    JOptionPane.showMessageDialog(null, "No Data on doctor fee that Year!");
                    jTextField1.setText(null);
                    jLabel15.setText(null);
                    jLabel14.setText(null);
                    jLabel16.setText(null);
                ...
                jLabel16.setText(df.format(Double.parseDouble(docsum)));
            }
            
            jLabel14.setText(df.format(Double.parseDouble(sum)+Double.parseDouble(docsum)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yearlypatientincome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new yearlypatientincome().setVisible(true);
            }
        });
    }
