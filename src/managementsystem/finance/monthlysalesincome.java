 ...
 * @author KALINDU
 */
public class monthlysalesincome extends javax.swing.JFrame {

    int xx,xy;
    /**
     * Creates new form monthlysalesincome
     */
    public monthlysalesincome() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("monthly sales income");
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        ...
        String sql="SELECT SUM(total_price) FROM sales WHERE purchaseDate LIKE '"+jTextField2.getText()+"-"+jComboBox1.getSelectedItem().toString()+"%'";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(monthlysalesincome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new monthlysalesincome().setVisible(true);
            }
        });
    }
